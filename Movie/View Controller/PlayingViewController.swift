...
class PlayingViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PlayingCollectionViewCell", for: indexPath as IndexPath) as! PlayingCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let controller: PlayingDetailsViewController = storyboard?.instantiateViewController(withIdentifier: "PlayingDetailsViewController") as! PlayingDetailsViewController
    ...
    func downloadJSON(completed: @escaping () -> () ) {
        ...
        let url = URL(string:"https://api.themoviedb.org/3/movie/now_playing?api_key=14d118971c4e8e277c631fba14844033")
