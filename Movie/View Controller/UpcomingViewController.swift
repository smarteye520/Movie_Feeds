...
class UpcomingViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "UpcomingCollectionViewCell", for: indexPath as IndexPath) as! UpcomingCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let controller: UpcomingDetailsViewController = storyboard?.instantiateViewController(withIdentifier: "UpcomingDetailsViewController") as! UpcomingDetailsViewController
    ...
    func downloadJSON(completed: @escaping () -> () ) {
        ...
        let url = URL(string:"https://api.themoviedb.org/3/movie/upcoming?api_key=14d118971c4e8e277c631fba14844033")
