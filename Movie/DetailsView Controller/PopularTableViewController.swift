...
class PopularDetailsViewController: UIViewController, UICollectionViewDataSource , UICollectionViewDelegate
    
{
    ...
    override func viewDidLoad() {
        ...
        //
        //        for count in 1...2 {
        //            let movieCollectionImage = UIImage(named: "Image\(count).jpg")
        //        self.movieCovers.append((movieCollectionImage)!)
        //
        //        }
        ...
        //        collectionView.dataSource = self
        //              collectionView.delegate = self
        //        let movieCollectionImage = UIImage (named: "Image1.jpg")
        //                             self.movieCovers.append((movieCollectionImage)!)
        ...
        DispatchQueue.main.async {
            ...
            // let rating = movieResults?.vote_average!
            //  movieRating.text = ("\(movieResults?.vote_average ?? 0.0)")
